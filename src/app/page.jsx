...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Premium Editorial Hero Section (Asymmetrical with Fast Image Reveal) */}
      <section className="relative min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#FAFAF9] pt-24 pb-12 lg:pt-0 lg:pb-0">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center mt-8 lg:mt-0">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left pt-6 lg:pt-0">
            ...
            >
              ...
              <div className="h-px w-12 bg-[#B85E44]/40" />
            </motion.div>
            ...
            >
              ...
              <span className="relative inline-block mt-2">
                ...
                <motion.span 
                  className="absolute bottom-1 lg:bottom-3 left-0 h-[3px] lg:h-[4px] w-full bg-[#B85E44]/20 rounded-full origin-left"
                  initial={{ scaleX: 0 }}
                  animate={{ scaleX: 1 }}
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-slate-600 mb-12 max-w-xl leading-relaxed font-light tracking-wide"
            >
          ...
          {/* Right Column: Premium Image Reveal */}
          <div className="lg:col-span-5 relative h-[45vh] md:h-[55vh] lg:h-[75vh] w-full flex justify-end items-center mt-6 lg:mt-0">
            {/* Arched Image Mask */}
            <motion.div 
              className="relative w-full max-w-[420px] h-full overflow-hidden rounded-t-[200px] rounded-b-[40px] shadow-[0_30px_60px_-20px_rgba(184,94,68,0.2)] border-[6px] border-white/80"
              initial={{ opacity: 0, y: 100, filter: "blur(20px)" }}
              animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
              transition={{ duration: 1.8, ease: [0.16, 1, 0.3, 1], delay: 0.4 }}
            >
              <motion.img
                src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1200&q=80&fm=webp"
              ...
              />
              <div className="absolute inset-0 bg-[#B85E44]/5 mix-blend-multiply" />
            </motion.div>

            {/* Floating Ornamental Badge */}
            <motion.div
               className="absolute top-8 md:top-12 -left-4 md:-left-12 w-24 h-24 md:w-28 md:h-28 bg-white/90 backdrop-blur-md rounded-full flex items-center justify-center shadow-xl border border-white/50 z-20"
               initial={{ opacity: 0, scale: 0.5, rotate: -45 }}
               animate={{ opacity: 1, scale: 1, rotate: 0 }}
               transition={{ duration: 1.5, delay: 1.5, type: "spring", stiffness: 50 }}
            >
               <span className="text-[9px] uppercase tracking-[0.2em] font-semibold text-slate-800 text-center leading-relaxed">
                  Est.<br/><span className="text-[#B85E44]">2026</span><br/>Dhaka
               </span>
            </motion.div>
          </div>
        </div>
